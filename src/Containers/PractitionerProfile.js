...
export default class PractitionerProfile extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <div classNameName="row py-20 px-10 ">
    <div className="col-md-10 mx-auto">
        {/* <!-- Profile widget --> */}
        <div className="bg-purple-100 shadow rounded overflow-hidden">
            <div className="px-4 pt-20 pb-4 cover">
                <div className="media align-items-end profile-head">
                    <div className="profile mr-10"><img src={this.props.practitionerInfo.image} alt="..." width="130" className="rounded mb-2 img-thumbnail"/><a href="#" className="btn btn-outline-dark btn-sm btn-block">Add Practitioner</a>
            ...
            <div className="py-4 px-4">
                ...
                {this.state.showForm ? <ReviewForm /> : <ReviewForm />}
                <div className="row">
